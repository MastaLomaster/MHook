	...
	while(!flag_ShutDownThreads)
	{
		...
		if(20==num_scanned)
		{
			...
			if(7==state)
			{
				...
				gd.left.gaze_point_on_display_normalized.x=p.x/(double)screen_x*screen_scale;
				gd.left.gaze_point_on_display_normalized.y=p.y/(double)screen_y*screen_scale;
